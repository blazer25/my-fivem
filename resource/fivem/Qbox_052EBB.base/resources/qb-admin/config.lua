...
Config.EnableDebug                          = Enable                 -- Whether to enable debug prints or not
...
Config.ServerName                           = "Life$tyle RolePlay"
Config.ServerDiscord                        = "https://discord.gg/G3ZnJmuh" -- For kick/ban messages
