    ...
    Bridge = {
        GetPlayer = ESX.GetPlayerFromId, GetPlayerFromCharacterIdentifier = ESX.GetPlayerFromIdentifier, GetOfflinePlayerFromCharacterIdentifier = function(CitizenId)
            ...
            local FixedPlayerData = {
                ...
                steamid = PlayerData.identifier, citizenid = PlayerData.identifier, gender = PlayerData.sex, nationality = 'Unknown', phone = PlayerData.phone_number, accountid = 'Unknown', hunger = hunger or 100, thirst = thirst or 100, injail = 'Unknown',
            ...
            for _, strPlayerId in pairs(GetPlayers()) do
                ...
                if Player then
                    ...
                    table.insert(PlayerList, {
                        ...
                        steamid = steamIdentifier, citizenid = Player.identifier, gender = Player.get('sex'), nationality = 'Unknown', phone = 'Unknown', accountid = 'Unknown', hunger = hunger, thirst = thirst, injail = 'Unknown',
