...
local function ExplosionEvent(sender, data)
    ...
    local baseDispatchData = table.clone(explosionOptions.dispatch or {})
    ...
    local dispatchData = table.combine({
        job = "police",
        priority = explosionOptions.dispatch.priority or "medium",
        title = L("BACKEND.BASE_DISPATCH.EXPLOSION.TITLE", { location = locationName }),
        description = L("BACKEND.BASE_DISPATCH.EXPLOSION.DESCRIPTION", { location = locationName }),
