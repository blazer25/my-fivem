...
---@alias CheckEvent "openPhone" | "createDarkChatChannel" | "joinDarkChatChannel" | "sendDarkchatMessage" | "startInstaPicLive" | "joinInstaPicLive" | "postInstaPicStory" | "buyCrypto" | "sellCrypto" | "transferCrypto" | "playNativePhoneSound"
